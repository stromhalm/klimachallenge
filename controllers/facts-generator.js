klimaChallenge.directive('factsGenerator', function () {
	function link($scope, element) {
		...
		var facts = [
			...
			'Fleischreiche Ernährung benötigt ca. 3-5  mal so viel Land wie pflanzenbasierte Ernährung.',
			...
			'Rund 80 Prozent des gesamten Energieverbrauchs im Haushalt gehen auf das Konto von Heizung und Warmwasserproduktion für Dusche und Co. Insgesamt ist Heizen für ein Drittel der in Deutschland verbrauchten Energie verantwortlich. Tipp: Schon 1°C weniger im Raum spart ca. 6% Energie.',
			'Jede Sekunde wird eine Regenwaldfläche von etwa einem halben Fußballfeld gerodet.',
			'Das Potenzial der Erneuerbaren: Die Europäische Union könnte schon bis 2030 (theoretisch) rund 70% ihres Stroms kostengünstig aus erneuerbaren Energien herstellen, wie eine Greenpeace-Studie berechnet hat.',
