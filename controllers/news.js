klimaChallenge.controller('newsCtrl', function($scope, $http, $sce) {
   ...
   $http.get('https://graph.facebook.com/v2.4/klimachallenge/photos/uploaded?fields=link,height,name,images&limit=5&access_token=846767055411205|UKF39DbxTvvEeA9BuKkWsJgiuLE').
