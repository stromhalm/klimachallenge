klimaChallenge.factory("projects", function($firebaseArray) {
   ...
   var events = [
      ...
      {name: 'Sonstige Aktionen', type: 3, question: 'Wie viele kg CO2 habt ihr durch die Aktion eingespart?', assessment: 1, placeholder: 'Für noch mehr Klimapunkte: Wie viel klimawirksame Emissionen (in kg CO<sub>2</sub>-Äquivalent) wurden durch eure Aktion eingespart? Wir schlagen vor: Finde es selbst heraus! Per Suchmaschine suchst du dafür am besten eine Kombination aus den Produkten, die ihr eingespart/ausgetauscht habt und Begriffen wie <i>Carbon Footprint</i>, <i>CO<sub>2</sub></i>, oder <i>klimawirksam</i> ein. Eine Abschätzung ist ausreichend. Wenn Du keine Infos findest, trage einfach <b>0</b> ein. Wir werden dann anhand deiner Angaben versuchen, die Emissionseinsparungen der Aktion zu bewerten.'}
   ];
