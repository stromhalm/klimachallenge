klimaChallenge.factory("projects", function($firebaseArray) {
   ...
   var events = [
      ...
      {name: 'Sonstige Aktionen', type: 3, question: 'Wie viele kg CO<sub>2</sub> habt ihr durch die Aktion eingespart?', assessment: 1, placeholder: 'Für noch mehr Klimapunkte: Wie viel klimawirksame Emissionen (in kg CO<sub>2</sub>-Äquivalent) wurden durch eure Aktion eingespart? Wir schlagen vor: Finde es selbst heraus, z.B. per Suchmaschine oder auf der Website www.eingutertag.org. Für die Berechnung: Dort entspricht ein "Punkt" übrigens 68g CO<sub>2</sub>. Eine Abschätzung ist ausreichend. Wenn Du keine Infos findest, trage einfach <b>0</b> ein. Wir versuchen dann anhand deiner Kurzbeschreibung, die Emissionseinsparungen zu bewerten.'}
   ];
